 ...
 * 解题：
 * 	本题重点思路：
 * 	假设来到99位置，0~99位置，最多能切成几个部分，0和1比例相等
 * 	假设0~99位置0和1的比例是2：3，那么切成的每个部分里，0和1的比例也得是2：3
 * 	所以，就看0~98按2：3切了几个部分出来了，剩下的部分和99位置拼起来也一定是2：3，为什么？因为0~99整体是2：3，切出来的每个部分都是2：3
 * 	所以想到了求点共线的模型
 * @see class25.Code03_MaxPointsOnALine
 */
