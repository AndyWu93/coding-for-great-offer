 ...
 * 	范围上的尝试，
 * 思路：
 * 	L位置的字符参与消除，那就要在L,R中找到一个与之能够消除的字符，并贡献了2个长度，L,R剩下的范围内，递归求出长度，加起来
 * 	L位置的字符不参与消除，那就求出L+1,R的最大全消子序列长度
 *
 */
// 体系学习班，代码46节，第2题+第3题
